    ...
    <div>
      ...
      <section className="mt-[120px] px-8">
        <div className="container mx-auto">
          <div className="bg-blue-100 rounded-full py-[80px] mb-10 text-center">
      ...
      <motion.div
        className="max-w-4xl mx-auto my-10 bg-blue-50 rounded-lg px-6 py-8 text-center shadow-md relative overflow-hidden"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5, delay: 0.6 }}
      >
